PROGRAM simulacion_montecarlo_pulverizacion_3d_fe
    ...
    CHARACTER(LEN=2), PARAMETER :: MATERIAL_TYPE = 'Fe'  ! Material: Hierro
    REAL, PARAMETER :: ADHESION_BASE = 0.95     ! Probabilidad base de adhesión
    REAL, PARAMETER :: ENERGIA_DIFUSION_BASE = 0.7  ! Energía de difusión (eV)
