      ...
      REAL, PARAMETER :: KB = 8.617E-5, ED = 0.7, T_SUBS = 500.0, T_PLASMA = 1000.0
      REAL, PARAMETER :: STICKING = 0.85, LAMBDA = 20000.0
      ...
      CALL save_data(material, L, H, 'fe_3d_height.dat', ED, T_SUBS, LAMBDA, STICKING)

      PRINT *, 'Simulación 3D para Fe completada. Ver fe_3d_height.dat'
      STOP
      CONTAINS
                  ...
                  IF (P_diff > r .AND. z_max > 2) THEN
                      ...
                      SELECT CASE (direction)
                          ...
                          CASE (3) ! Derecha
                              ...
                              IF (new_x > L) new_x = 1
                      END SELECT
                      material(new_x, new_y, z_max+1) = 2
      ...
      SUBROUTINE save_data(material, L, H, filename, ed, t_subs, lambda, sticking)
          ...
          WRITE(10, '(A)') '# Simulación KMC 3D para sputtering (Fe)'
