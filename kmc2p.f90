program kmc_sputtering_simulation
    ...
    real, parameter :: E_diff = 0.7e-19   ! Energía de activación para la difusión de Fe en J
    real, parameter :: E_des = 1.4e-19    ! Energía de activación para la desorción de Fe en J
    ...
    ! Archivos de salida
    character(len=*), parameter :: output_file = 'height_map_fe.dat'
    character(len=*), parameter :: gnuplot_script = 'plot_script_fe.gnu'
    ...
    write(20, *) 'set output "height_map_fe.png"'
    write(20, *) 'set title "Height Map after ', nparticles, ' particles (Fe)"'
...
contains
    ...
    subroutine interact(x, y, energy, height, chemisorbed, nx, ny, angle)
        ...
        real, parameter :: E_ads = 1.3e-19  ! Energía de activación para la adsorción de Fe en J
        real, parameter :: E_sput = 2.3e-19 ! Energía de activación para el sputtering de Fe en J
        ...
        reflection_prob = 0.2
        chemisorption_prob = 0.1 * exp(-E_ads / (kB * 300.0))  ! Ajustado para Fe
