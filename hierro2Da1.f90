      ...
      CALL save_data(height, L, 'fe_2d_height.dat', ED, T_SUBS, LAMBDA)
      ...
      SUBROUTINE initialize_grid(height, L)
          ...
          REAL :: r
          height = 0.0
          DO CONCURRENT (i = 1:L, j = 1:L) ! Optimización con DO CONCURRENT
      ...
      SUBROUTINE save_data(height, L, filename, ed, t_subs, lambda)
          ...
          DO CONCURRENT (i = 1:L, j = 1:L) ! Optimización
